![223Cube Rubik's Cube](images/223_rubiks_cube.png)
...
By analyzing the generated solutions, cube enthusiasts can extract useful move sequences, study efficient solving techniques, and even develop personalized solving methods.

## Features

 - Using pure C Language: Faster and minimization of memory usage.
...
## To-Do
 ...
 - GUI version for 233 cube solver.
...
### corners (1d array of Integers) key:
 ...
 - Coordinate System ()
   ...
   ![corner coordinate system](images/corner_coordinate.png)
...
### edges (1d array of Integers) key:
 ...
 - Coordinate System (First 4 values for edge positions)
   ...
   ![corner coordinate](images/edge_coordinate.png)
...
### Full Example (The blue faces forward and the yellow faces upward):
   ...
   So in this case edges = [1, 2, 0, 3, 1, 4]

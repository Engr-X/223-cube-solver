...
223CubeSolver/
│
├── .vscode/                    # project settings. Generated by vscode
│
...
I provided three types of examples.
 ...
 - full_settings.json: conatins all moves in 223 Cube (R, U, E, D, F, L, B, Uw, and Dw)
...
### edges (1d array of Integers) key:
 ...
 - Coordinate System (First 4 values for edge positions)
   [!corner coordinate system](images/edge_coordinate.png)
